---
granule: CREC-2009-07-27-pt1-PgS8110-2
date: 2009-07-27
edition: CREC
section: SENATE
page: S8110
citation: 155 Cong. Rec. S8110
---

# ENERGY AND WATER DEVELOPMENT AND RELATED AGENCIES APPROPRIATIONS ACT, 2010

**Speaking:** Dorgan, Byron L. (D000432) [D-ND], Bennett, Robert F. (B000382) [R-UT], Inouye, Daniel K. (I000025) [D-HI], Inhofe, James M. (I000024) [R-OK], Nelson, Bill (N000032) [D-FL], Sessions, Jeff (S001141) [R-AL]

**Measures:** S. 370, H.R. 3183
...
as amended, be reported to the Senate. That is, the full Appropriations 
Committee has recommended this bill, on a bipartisan basis, without 
objection, 30 to 0.
...
about earlier remind me that 5 to 10 years ago we could not drill in 
...
a lower carbon future you have to decarbonize the use of coal. So we 
need to make substantial investments to be able to decarbonize the use 
of coal.
...
take the old refrigerator and put it in the garage to store beer 
and soda. I recognize we need to get rid of those old refrigerators, 
...
I did wish to say once again that we received a lot of recommendations 
from the President for earmarking the funding for various projects, and 
we have included many of these. We have also included projects that 
were recommended by the Members of Congress that were well underway.
...
significantly below that which the

[[Page S8113]]

President requested. If it had been a single partisan effort, I am 
assuming it would have been responsive entirely to the President's 
request.
...
directing the Secretary to conduct an evaluation of the sufficiency of 
the fund and suspend the annual collection from ratepayers until he has 
a strategy to address the issue of spent fuel inventory.
...
its third appropriations bill for fiscal year

[[Page S8114]]

2010. The bill before the Senate provides funding for the Department of 
Energy, the Army Corps of Engineers and for related agencies. The 
funding in the bill totals $33.75 billion. This is nearly $650 million 
lower than the administration requested.
...
Once built, nuclear power plants do not emit CO<INF>2</INF> and 
...
CO<INF>2</INF> in on one side of the engine and water in on the other 
...
for hydrogen, biomass and biorefineries, solar energy, wind energy, 
geothermal energy, vehicle technologies, building technologies, 
industrial technology, weatherization, State energy programs, advanced 
battery manufacturing, and more.
...
developed through the authorization committees, and no small part is 
developed in what we fund in the Department of Energy. Exactly the same 
...
consent cannot be entertained at this point. He

[[Page S8117]]

has not consulted with the majority leader who is in charge of 
scheduling legislative matters to come to the floor of the Senate. So 
on behalf of the majority leader, I object.
...
manmade gases, anthropogenic gases, CO<INF>2</INF>, methane, were 
...
you pass a tax on CO<INF>2</INF>? I would say: If you want to get rid 
of CO<INF>2</INF> and be honest and straightforward, go ahead and pass 
...
[[Page S8118]]
     ...
     them along to their customers in the form of higher prices.
  ...
  Continuing his quote:
     ...
     reduced CO<INF>2</INF> emissions.
  ...
  He said further:
       ...
       If you didn't auction the [CO<INF>2</INF>] permits, it 
...
of a CO<INF>2</INF> cap would be similar to those of raising such 
...
that.
  ...
  That is a good statement.
     ...
     chase more jobs to China and India, where they've been 
...
CO<INF>2</INF> in the atmosphere?
...
CO<INF>2</INF> that goes into the atmosphere. In fact, you could 
...
would have a net increase of CO<INF>2</INF>.
...
Florida cities and other cities in the country for travel

[[Page S8119]]

and conferences because they are looked at as a vacation or resort 
destination.
...
one reads the entire speeches, the context makes them worse, not 
better.
...
reached erroneous conclusions. They ignore the plain words of the 
Constitution, and they provide a direct look at how the nominee will 
decide many important cases that will come before the Court, if she is 
confirmed, in the decades to come.
...
the Heller case that the second amendment, which protects the right of 
...
case, we don't decide the

[[Page S8121]]

application of the second amendment to the States. But in that 
footnote, the Court made it quite clear that the prior old cases were 
decided before it had adopted a different approach to incorporating 
constitutional rights against the States. It is pretty clear from that 
they have left this matter open. The judge on the Ninth Circuit found 
that the question was an open question after Heller.
