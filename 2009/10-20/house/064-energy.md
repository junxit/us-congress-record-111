---
granule: CRECB-2009-pt19-Pg25204
date: 2009-10-20
edition: CRECB
section: HOUSE
page: 25204
...
that puts as much CO<INF>2</INF> into the air as burning oil or gas or 
diesel fuel does.
...
petroleum because some people say that it produces more CO<INF>2</INF>. 
I'll not argue the science of that, but this myopic belief that we can 
limit the emissions of CO<INF>2</INF>s and that somehow or another we 
...
upon a flawed premise such as CO<INF>2</INF> emissions by the United 
States have dramatically increased the temperature on the planet and if 
we significantly reduce the CO<INF>2</INF> emissions in the United 
...
draw how big would the circle be, the circle of CO<INF>2</INF>, carbon 
...
CO<INF>2</INF>, the cumulative level of all CO<INF>2</INF> emitted by 
...
been burned and then the CO<INF>2</INF> that has been emitted and 
...
CO<INF>2</INF> in the atmosphere be in 205 years?
...
and that means 205 years' worth of CO<INF>2</INF> from the United 
...
CO<INF>2</INF> is .56 inches, Mr. Speaker. That is about like this, 
...
diameter. That is the cumulative total of all the CO<INF>2</INF> in 205 
years.
