---
granule: CRECB-2009-pt9-Pg12405
date: 2009-05-13
edition: CRECB
section: HOUSE
page: 12405
...
that is the general idea that mankind is making CO<INF>2</INF>--that's 
the product of burning something. When you burn something, the oxygen 
in the atmosphere combines with the fuel and it makes CO<INF>2</INF>. 
It's the bubbles in soda pop. So we drink CO<INF>2</INF>, as a matter 
of fact. And in a sense, the soda pop manufacturer is sequestering the 
CO<INF>2</INF> in bottles of soda pop and you are letting it loose when 
you open the can. Anyway, the theory is that CO<INF>2</INF> is the 
culprit, and therefore we have to reduce the amount of CO<INF>2</INF>. 
And so this tax is being justified to reduce CO<INF>2</INF> so the 
...
reducing CO<INF>2</INF> or is this just a big excuse to levy a big tax 
...
CO<INF>2</INF> and it makes very, very clean energy.
...
heating their gas with in order to try to get CO<INF>2</INF> down, and 
...
it's going to have the effect of creating more CO<INF>2</INF> than if 
...
time we sited a new nuclear power plant?
  Mr. LATTA. In 1977.
  Mr. AKIN. And that makes how much CO<INF>2</INF>?
  Mr. LATTA. Zero.
  Mr. AKIN. None. So we're all worried about CO<INF>2</INF>, and yet we 
...
about CO<INF>2</INF> and nuclear power plants don't generate any 
CO<INF>2</INF> and we have hundreds of them floating around in ships in 
...
that makes no CO<INF>2</INF>. Now, what's the logic of this? Please 
...
CO<INF>2</INF>. Even if you assume that, there are a lot of ways to 
deal with this.
...
because nuclear makes zero CO<INF>2</INF>. And yet they closed them and 
...
people and scientists, first of all, on the amount of CO<INF>2</INF> 
that we are really generating, that human beings are generating. That's 
not absolutely agreed to among scientists at all.
  The fact is that human beings add something to the CO<INF>2</INF> in 
...
what are the effects that if we have the CO<INF>2</INF>, what is that 
...
Capitol steps. That's what people are saying.
  ...
  So the question is, first of all: How much CO<INF>2</INF> are we 
contributing? Second of all, what will be the effect of that 
CO<INF>2</INF>. Then, the next question is: What is our ability to do 
...
really about a concern for CO<INF>2</INF>, or is really the global 
...
here, then CO<INF>2</INF> is those yellow boxes. That's the amount of 
greenhouse gas that's heating the world by CO<INF>2</INF>. The rest of 
