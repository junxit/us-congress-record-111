---
granule: CREC-2009-04-21-pt1-PgE919
date: 2009-04-21
edition: CREC
section: EXTENSIONS
page: E919
citation: 155 Cong. Rec. E919
---
...
other side of aisle.
     ...
     the CO<INF>2</INF> price and how many allowances are issued--
     allowances tell us how many tons of CO<INF>2</INF> (or more 
     ...
     CO<INF>2</INF> price reflects the cost of the last ton of 
     emissions reduced but there are many options that cost much 
     less than avoiding the last ton and so using the 
     CO<INF>2</INF> price multiplied by the number of tons (either 
     ...
     time and it is wrong to produce a simple average of such 
     costs as that does not take account of the time value of 
     money.
     ...
     simplistic and misleading to only look at

[[Page E920]]

     the impact on energy prices of these proposals as a measure 
     of their impact on the average household. Concern about the 
     cost impacts on middle and low income families needs to be 
     focused on making sure allowance or tax revenue is used to 
     offset cost impacts on these households rather than as an 
     excuse for not proceeding with measures that would help avert 
