---
granule: CREC-2009-07-22-pt1-PgS7871
date: 2009-07-22
edition: CREC
section: SENATE
page: S7871
citation: 155 Cong. Rec. S7871
---

# STATEMENTS ON INTRODUCED BILLS AND JOINT RESOLUTIONS

**Speaking:** Leahy, Patrick J. (L000174) [D-VT], Levin, Carl (L000261) [D-MI], Mikulski, Barbara A. (M000702) [D-MD], McConnell, Mitch (M000355) [R-KY], Cantwell, Maria (C000127) [D-WA], Casey, Robert P., Jr. (C001070) [D-PA], Enzi, Michael B. (E000285) [R-WY], Specter, Arlen (S000709) [D-PA]

**Measures:** S. 1490, S. 1491, S. 1492, S. 1493, S. 1497, S. 1502, S. 1504
...
the risk and liability of injecting large volumes of CO<INF>2</INF> 
...
stored.
  The risk of geological CO<INF>2</INF> storage, also commonly known as 
carbon sequestration, is considered small. In fact, CO<INF>2</INF> has 
...
for CO<INF>2</INF> to leak to the surface and cause human or ecological 
...
CO<INF>2</INF> in perpetuity. This uncertainty can cause a chilling 
...
CO<INF>2</INF> . This program will offer the private sector with a 
...
commercial CO<INF>2</INF> storage facility to self insure or obtain 
private insurance or other types of financial assurance to cover 
liability claims during the CO<INF>2</INF> injection phase of the 
...
operators on a per ton of CO<INF>2</INF> injected basis that will be 
used to pay for
...
need regarding the longterm stewardship of CO<INF>2</INF> storage 
...
storage of CO<INF>2</INF> in geological formations.
...
strategy to reduce emissions of CO<INF>2</INF>.
  Mr. President, I ask unanimous consent that the text of the bill be 
printed in the Record.
  There being no objection, the text of the bill was ordered to be 
printed in the Record, as follows:
...
address one issue with CCS liability for the stored CO<INF>2</INF>.
  Our legislation sets up a framework that answers the question of who 
is responsible for the CO<INF>2</INF> once it is placed underground. 
The Carbon Storage Stewardship Trust Fund Act of 2009 requires 
companies injecting CO<INF>2</INF> into the ground to obtain private 
liability insurance for a period of time. After the CO<INF>2</INF> is 
injected and the injection site is certified as closed by the Federal 
Government, liability for the CO<INF>2</INF> is transferred to the 
Federal Government.
  To cover any claims that may arise from damages caused by the 
injected CO<INF>2</INF>, the bill sets up a Federal trust fund that is 
paid for through a small fee charged for each ton of CO<INF>2</INF> 
...
important question about long-term liability of CO<INF>2</INF>. I 
...
resources of our executive-branch and administrative agencies stretched 
thin, the enforcement of Federal antitrust, consumer protection, civil 
rights and other laws that benefit the public will fall increasingly to 
private litigants.
