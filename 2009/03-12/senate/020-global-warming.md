...
that manmade gases--CO<INF>2</INF>, methane--were the cause of the 
global warming.
...
CO<INF>2</INF> and anthropogenetic gases are causing global warming, if 
...
CO<INF>2</INF> after we paid the tax and the punishment for it.
...
CO<INF>2</INF> that is causing global warming, is the recipient of 
...
founding director of the U.S. Weather Satellite Service.
     ...
     CO<INF>2</INF> emissions is not concern about climate. 
     Ultimately, ideology may be what's fueling the CO<INF>2</INF> 
     wars.
...
would be a CO<INF>2</INF> tax. They don't call it that. They disguise 
