---
granule: CREC-2009-07-16-pt1-PgH8294
date: 2009-07-16
edition: CREC
section: HOUSE
page: H8294
citation: 155 Cong. Rec. H8294
---
...
calculation was that we were putting too many tons of CO<INF>2</INF> in 
the air annually.
...
CO<INF>2</INF> you put into the atmosphere, and it's supposed to be 
offset by somebody else's behavior because you've reached your limit of 
being able to limit the CO<INF>2</INF> emissions you have here.
  So I tracked that; $89,000 spent on the board of trade to pay 
indulgences for the CO<INF>2</INF> emissions that take care of this 
...
that there is too much CO<INF>2</INF> emitting in the atmosphere 
...
emissions of CO<INF>2</INF> continued, and we had to get to this zero 
...
diminished the CO<INF>2</INF> in the atmosphere sometime a couple years 
earlier.
...
in this Congress. If we're going to provide contraception for wild 
horses, it will be enhanced. That's what we want to do.
...
million earmark for the Speaker to take care of her neighbors by San 
Francisco with these little earmark pet projects.
...
American people focus on. These are the traditional health insurance 
plans. They exist. And there's some number I saw the other day, it was 
around 1,300 different companies selling health insurance in America. 
That's a lot of competition. Those that survive the insurance czar--I 
don't know if he actually exists today, but there are 32 of them, and 
it doesn't take long to create another one--these existing insurance 
companies that have 70 percent of the people pleased with the health 
care plan that they have, these qualified health benefit plans would be 
the plans that are approved by Obama's insurance czar. So we wouldn't 
have the same competition that we have today, not the same policies we 
have today. We would only have the policies that are permitted under 
the bill, policies that would require that they fund abortion, policies 
that would require mental health, policies that would require little or 
no deductible and little or no copayment plan because they have to be 
...
by putting people on

[[Page H8300]]

lists, rationing health care, having more general practitioners, 
getting rid of so many specialists that have made such great strides 
forward, and then people dying on the list waiting to get health care.
