---
granule: CREC-2010-06-30-pt1-PgS5690-2
date: 2010-06-30
edition: CREC
section: SENATE
page: S5690
citation: 156 Cong. Rec. S5690
---
...
rely on healthy fish from a healthy bay.
  The cap on sulfur dioxide, SO<INF>2</INF>, levels in the Clean Air 
Act Amendments of

[[Page S5691]]

2010 is strong as well. SO<INF>2</INF> is a harmful particulate that is 
...
has yielded tremendous success and the SO<INF>2</INF> reductions that 
the bill calls for would help us achieve greater SO<INF>2</INF> 
reductions.
...
important measures to protect the public health and the environment.
  Nitrogen Oxide, NO<INF>X</INF>, is a dangerous air pollutant that 
...
achieve attainment of healthy air standards because of NO<INF>X</INF> 
emissions. The Federal Government must do what it can to help these 
States achieve healthy air through reductions in NO<INF>X</INF>.
  I am committed to working with Senators Carper and Alexander to make 
the bill achieve the goal of NO<INF>X</INF> reductions to protect the 
...
mercury, SO<INF>2</INF> and NO<INF>X</INF> emissions in the State by 
...
the State well on its way to reducing NO<INF>X</INF> emissions in 
Maryland by 75 percent by 2012, after already achieving an interim goal 
of 70 percent reduction target for NO<INF>X</INF> in 2009. 
SO<INF>2</INF> emissions will be reduced by 80 percent this year with a 
second phase of controls in 2013 to achieve 85 percent SO<INF>2</INF> 
...
achieving significant mercury, SO<INF>2</INF> and NO<INF>X</INF> 
...
SO<INF>2</INF> reductions goals. Because Maryland has taken positive 
steps to also reduce NO<INF>X</INF> emissions I must work to ensure 
that any national standard supports Maryland's healthy air attainment 
limits for NO<INF>X</INF> as well.
...
that additional NO<INF>X</INF> emissions reductions are necessary to 
...
NO<INF>X</INF> to address this public health threat.
